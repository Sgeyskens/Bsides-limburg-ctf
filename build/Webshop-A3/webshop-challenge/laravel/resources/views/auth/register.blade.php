...
<head>
    ...
    <title>Register - Friday the 13th</title>
...
<body class="bg-black text-white overflow-x-hidden">
    ...
    <div class="min-h-screen relative overflow-hidden">
        ...
        <!-- Content Wrapper -->
        <div class="relative z-40 px-4 md:px-8 lg:px-16 py-12 min-h-screen flex items-center justify-center">

            <!-- Main Content - Register Form -->
            <div class="max-w-lg w-full">
                <!-- Register Title with Friday 13th Font -->
                <h2 class="friday13-title text-4xl md:text-6xl mb-2">
                    REGISTER
                </h2>

                <p class="font-cinzel text-sm text-[#D8C9AE] mb-4 uppercase tracking-wider">
                    Ready for your first night at the lake?
                </p>
                ...
                <!-- Register Form Card with Rounded Corners -->
                <div class="relative border-2 border-red-700/80 rounded-lg p-5 md:p-6 bg-black/80">
                    <form method="POST" action="{{ route('register') }}" class="space-y-3">
                        ...
                        <div class="flex items-center gap-2">
                            <input
                                ...
                                id="terms"
                                required
                                class="w-4 h-4 border border-red-700/80 rounded bg-transparent checked:bg-red-700 focus:outline-none"
                            >
                            <label for="terms" class="text-[#D8C9AE] font-cinzel text-xs">
                    ...
                    <div class="mt-4 text-center">
                        <p class="text-[#D8C9AE] font-cinzel text-xs">
                            ...
                            <a href="{{ route('login') }}" class="text-red-500 hover:text-red-400 transition-colors">Login</a>
                        </p>
                    </div>
                </div>
